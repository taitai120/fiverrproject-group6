...
function CommentsComponent({ commentList }) {
  const renderComments = () => {
    if (commentList.length === 0) {
      return (
        <div>
          <p>No comment for this job.</p>
        </div>
      );
    } else {
      return commentList?.map((item, index) => (
        <div className="commentscomponent__item" key={index}>
          <div className="commentscomponent__title">
            <div className="commentscomponent__title__avatar">
              <Avatar className="avatar" icon={<UserOutlined />} />
            </div>
            <div className="commentscomponent__title__user">
              <p className="text-weight">
                {item.user ? item.user.name : "Unnamed"}
                <span>
                  <svg
                    width="16"
                    height="15"
              ...
              <div className="commentscomponent__title__country">
                <img
          ...
          <div className="commentscomponent__description">
            <p>{item.content}</p>
            <p className="posted">Published 1 month ago</p>
          </div>
          <div className="commentscomponent__react">
            <div className="react__thumbup">
              <span
                class="lFICM06 thumbs-icon"
                aria-hidden="true"
            ...
            <div className="react__thumbdown">
              <span
                class="lFICM06 thumbs-icon"
                aria-hidden="true"
                style={{ width: "14px", height: "14px" }}
  ...
  return (
    <div className="commentscomponent">
      <div className="commentscomponent__container">{renderComments()}</div>
    </div>
  );
}
