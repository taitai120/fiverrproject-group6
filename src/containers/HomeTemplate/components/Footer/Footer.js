  ...
  return (
    <div className="footer">
      <div className="footer__group">
        <div className="footer__item categories">
        ...
        <div className="footer__item community">
          <div className="footer__item__title">
            <h6>Community</h6>
          </div>
          <div className="footer__item__content">
        ...
        <div className="footer__item more">
          <div className="footer__item__title">
      ...
      <div className="footer__copyright">
        ...
        <div className="footer__copyright__right">
          ...
          <div className="settings__buttons">
            <div className="settings__buttons__language">
              <button>
                <span>
                  <svg
                    width="20"
            ...
            <div className="settings__buttons__currency">
              <button>
                <span>US$</span>
                <span> USD</span>
              </button>
            </div>
            <div className="settings__buttons__accessibility">
              <button>
                <span>
                  <svg
                    width="32"
