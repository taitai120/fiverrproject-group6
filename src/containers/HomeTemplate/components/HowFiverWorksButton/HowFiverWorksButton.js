...
import "./HowFiverWorksButton.scss";
import ModalVideo from "react-modal-video";

function HowFiverWorksButton() {
  const [isOpen, setIsOpen] = useState(false);
  return (
    <div className="howfiverworks">
...
export default HowFiverWorksButton;
